...
INSERT INTO `schema_version` VALUES (1,'1','mifos-platform-shared-tenants','SQL','V1__mifos-platform-shared-tenants.sql',-2077956380,'root','2022-01-09 16:44:38',63,1),(2,'2','externalize-connection-properties','SQL','V2__externalize-connection-properties.sql',-1714204083,'root','2022-01-09 16:44:38',51,1),(3,'3','deadlock-retry-properties','SQL','V3__deadlock-retry-properties.sql',-1359786045,'root','2022-01-09 16:44:38',41,1),(4,'4','introduced oltpId reportId columns and tenants server connection table','SQL','V4__introduced_oltpId_reportId_columns_and_tenants_server_connection_table.sql',-124371966,'root','2022-01-09 16:44:38',39,1),(5,'5','add schema connection parameters','SQL','V5__add_schema_connection_parameters.sql',-152366073,'root','2022-01-09 16:44:38',192,1),(6,'6','add unique tenant identifier','SQL','V6__add_unique_tenant_identifier.sql',-43094919,'root','2022-01-09 16:44:38',11,1);
...
INSERT INTO `tenant_server_connections` VALUES (1,'localhost','fineract_default','3306','root','mysql',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1,'');
...
INSERT INTO `tenants` VALUES (1,'default','Default Demo Tenant','Africa/Harare',NULL,NULL,NULL,NULL,1,1);
...
-- Dump completed on 2022-02-09  8:42:30
